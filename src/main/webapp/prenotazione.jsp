...
<body
	...
	<div class="footer-dark"
		style="margin-right: 0px; margin-bottom: 0px; margin-left: 0px; padding-bottom: 0px;">
		<footer>
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 item text footerNull" id="logoFooter"
						style="width: 300px; max-width: 35%;">
						<img src="assets/img/adisurclogo.png">
					</div>
				</div>
				<p class="copyright">Azienda al Diritto dello Studio
					Universitario della Regione Campania © 2021</p>
			</div>
		</footer>
	</div>
